...
module.exports = (sequelize, DataTypes) => {
  class tbl_activity_ripper extends Model {
    /**
  ...
  tbl_activity_ripper.init(
    {
      plot_key: DataTypes.STRING,
      plot_no: DataTypes.STRING,
      act_id: { type: DataTypes.INTEGER, defaultValue: 0 },
      ripper_type_id: { type: DataTypes.INTEGER, defaultValue: 0 },
      fertilizer_formula_id: { type: DataTypes.INTEGER, defaultValue: 0 },
      fertilizer_band_id: { type: DataTypes.INTEGER, defaultValue: 0 },
