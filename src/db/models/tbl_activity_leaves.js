...
module.exports = (sequelize, DataTypes) => {
  class tbl_activity_leaves extends Model {
    /**
  ...
  tbl_activity_leaves.init(
    {
      plot_key: DataTypes.STRING,
      plot_no: DataTypes.STRING,
      act_id: DataTypes.INTEGER,
      leaves_id: DataTypes.INTEGER,
      leaves_driver_id: DataTypes.INTEGER,
      leaves_register_id: DataTypes.INTEGER,
